...
def find_and_draw_digits(raw_image, processed_image, image_counter, save_results=False):
    ...
    smoothed_image = cv2.medianBlur(raw_image, 3)
    ...
    for i, contour in enumerate(contours):
        ...
        # Чистый Adaptive
        binary_roi = cv2.adaptiveThreshold(roi_clahe, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY_INV, 33, 11) # 21.7 roi_gray
